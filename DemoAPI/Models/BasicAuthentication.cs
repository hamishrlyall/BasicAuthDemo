    ...
    public class BasicAuthentication : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                //Split the username and password by " because client passwed the username and password as "userNameValue:Passwordve"
                string[] usernamePasswordArray = decodedAuthenticationToken.Split(':');
                string username = usernamePasswordArray[0];
                string password = usernamePasswordArray[1];
                UserManager _userRepository = new UserManager();
                
                //validated from the database for this username or password
